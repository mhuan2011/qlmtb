...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel_ThietBiBaoTri = new javax.swing.JLabel();
        ...
        jDialog_ThongTinNV.setMinimumSize(new java.awt.Dimension(570, 590));
        ...
        jLabel_ThietBiBaoTri.setFont(new java.awt.Font("sansserif", 1, 12)); // NOI18N
        jLabel_ThietBiBaoTri.setText("3. Danh sách thiết bị bảo trì");
        jLabel_ThietBiBaoTri.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jLabel_ThietBiBaoTri.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                jLabel_ThietBiBaoTriMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                jLabel_ThietBiBaoTriMouseExited(evt);
            }
        });
        ...
        jPanel19Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel19Layout.createSequentialGroup()
                ...
                .addGroup(jPanel19Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel_ThietBiBaoTri, javax.swing.GroupLayout.DEFAULT_SIZE, 161, Short.MAX_VALUE)
                    .addGroup(jPanel19Layout.createSequentialGroup()
                        .addGroup(jPanel19Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel19Layout.setVerticalGroup(
            ...
            .addGroup(jPanel19Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel_ThietBiBaoTri)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addComponent(jLabel_TenNV, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 173, Short.MAX_VALUE)
...
//        jComboBox_LocTheoLoaiTBDK.removeAllItems();
    ...
    //ghi file excel
    public void exportExcel(JTable table) throws FileNotFoundException, IOException {
...
//        
//        if(JFileChooser.APPROVE_OPTION == excelChooser){
//            FileOutputStream excelFOU = null;
//            BufferedOutputStream excelBOU = null;
//            try {
//                XSSFWorkbook excelJTableExpoter = new XSSFWorkbook();
//                XSSFSheet excelSheet = excelJTableExpoter.createSheet("Danh sach thiet bi");
//
//                for(int i = 0;  i < model.getRowCount(); i++){
//                    XSSFRow excelRow = excelSheet.createRow(i);
//                    for(int j = 0;  j < model.getColumnCount(); j++){
//                        XSSFCell excelCell = excelRow.createCell(i);
//                        excelCell.setCellValue((LocalDate) model.getValueAt(i, j));
//                    }
//                }
//                excelFOU = new FileOutputStream(excelFileChooser.getSelectedFile() + ".xlsx");
//                excelBOU = new BufferedOutputStream(excelFOU);
//                excelJTableExpoter.write(excelBOU); 
...
//            }
    ...
    private void jLabel_ThietBiBaoTriMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel_ThietBiBaoTriMouseEntered
        // TODO add your handling code here:
        jLabel_ThietBiBaoTri.setForeground(new Color(168, 168, 168));
    }//GEN-LAST:event_jLabel_ThietBiBaoTriMouseEntered

    private void jLabel_ThietBiBaoTriMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel_ThietBiBaoTriMouseExited
        // TODO add your handling code here:
        
        jLabel_ThietBiBaoTri.setForeground(new Color(0, 0, 0));
    }//GEN-LAST:event_jLabel_ThietBiBaoTriMouseExited
    ...
    private void jTable_NhanVIienMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable_NhanVIienMouseClicked
        ...
        if(nv != -1){
            ...
            String sql = "select * from NHANVIEN NV, TKNHANVIEN TKNV, TAIKHOAN TK where NV.MANV = ? and TKNV.MATK = TK.MATK and NV.MANV = TKNV.MANV";
            try {
                PreparedStatement ps = ketNoi.prepareStatement(sql);
                ps.setString(1, manv);
                ResultSet rs = ps.executeQuery();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MainFrame("QL01").setVisible(true);
    ...
    private javax.swing.JLabel jLabel_ThietBiBaoTri;
